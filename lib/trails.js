...
module.exports = {
  ...
  bindEvents (app) {
    if (app.bound) {
      app.log.warn('trails-app: Someone attempted to bindEvents() twice! Stacktrace below.')
    ...
    process.on('exit', () => {
      app.log.verbose('Event loop is empty. I have nothing else to do. Shutting down')
    })
